...
const name = defaultSettings.title || '管理系统', // 页面标题

  // port = 9528 npm run dev 或 npm run dev --port = 9528
  port = process.env.port || process.env.npm_config_port || 9528;

// 所有配置参考 https://cli.vuejs.org/config/
module.exports = {
  // publicPath: process.env.ENV === 'production' ? '//resource.dossen.com/xxx/' : '/',
  publicPath: '/',
  outputDir: 'dist',
  assetsDir: 'static',
  ...
  devServer: {
    ...
    proxy: {
      ...
      [process.env.VUE_APP_BASE_API]: {
        target: 'http://10.30.104.243:37800',
